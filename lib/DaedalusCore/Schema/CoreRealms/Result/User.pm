use utf8;
package DaedalusCore::Schema::CoreRealms::Result::User;
...
__PACKAGE__->add_columns(
  ...
  "phone",
  { data_type => "varchar", default_value => "", is_nullable => 1, size => 22 },
  "apikey",
  { data_type => "varchar", default_value => "", is_nullable => 0, size => 33 },
  "password",
...
# Created by DBIx::Class::Schema::Loader v0.07048 @ 2018-05-03 06:20:24
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:MqoRetYrY/SwEWIxA94OJQ
